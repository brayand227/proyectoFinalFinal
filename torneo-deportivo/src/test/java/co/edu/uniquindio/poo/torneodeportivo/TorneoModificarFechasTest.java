...
public class TorneoModificarFechasTest {
    ...
    public void modificarFechaInicio() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 8, 1),
                LocalDate.of(2023, 9, 15), (byte) 24, (byte) 0, 0, TipoTorneo.LOCAL, CaracterTorneo.GRUPAL,
    ...
    /**
     * Verificar que la clase Torneo no permita la modificación de la fecha de
     * inicio con un null
     * 
     */
    @Test
    ...
    /**
     * Verificar que la clase Torneo no permita la modificación de la fecha de
     * inicio con una fecha anterior a la de las inscripciones
     * 
     */
    @Test
    ...
    /**
     * Verificar que la clase Torneo no permita la modificación de la fecha de
     * inicio de inscripciones con un null
     * 
     */
    @Test

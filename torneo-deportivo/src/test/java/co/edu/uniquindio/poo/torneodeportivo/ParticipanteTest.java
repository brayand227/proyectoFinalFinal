...
public class ParticipanteTest {
        ...
        public void registrarParticipanteTorneo() {
                ...
                // fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL|INDIVIDUAL}
                ...
                Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                                LocalDate.now().plusDays(15), (byte) 24, (byte) 18, 0, TipoTorneo.LOCAL,
                                CaracterTorneo.INDIVIDUAL, TipoTorneoGenero.MASCULINO);
        ...
        /**
         * Verificar que no sea posible registrar dos participantes con el mismo nombre
         * completo en un mismo torneo
         * 
         */
        @Test
        ...
        /**
         * Verificar que no sea posible registrar un jugador como participante en un
         * torneo grupal.
         * 
         */
        @Test
        public void registrarParticipanteIndividualTorneoGrupal() {
                ...
                // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\|
                // fechaActual - 15 días\|fechaActual+15 días\|24\|18\|0\|LOCAL|GRUPAL}
                // Equipo{Uniquindio}
                // Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}, Jugador
                // {Christian,Candela,chrcandela@email.com,6067431234, fechaActual - 15 años},
                // Jugador {Christian,Candela,chrcandela@email.com,6067431234, fechaActual - 15
        ...
        /**
         * Verificar que no sea posible registrar un equipo en un torneo de carácter
         * individual
         * 
         */
        @Test
